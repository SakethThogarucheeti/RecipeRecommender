...
if (isset($_POST['login'])) {
    if (isset($_POST['uname']) && isset($_POST['upassword'])) {
    	...
    	$result = mysqli_query($con, "SELECT * FROM UserDetails WHERE uname = '" . $name. "' and upassword = '" . $password . "'");
    	...
    	if ($row) {
        	...
        	$errormsg = "We could not find a UserDetails with that UserDetailsname and password!!! Please try again";
    	}
    } else {
    	echo 'You must supply a UserDetailsname and password.';
	}
} 
...
<html>
<head>
    <title>UserDetails Login Page</title>
...
<div class="container">
            ...
            <form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="loginform">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="uname">Enter Your UserDetails Name</label>
                        <input type="text" name="uname" id ="name" placeholder="Enter Your UserDetails Name" value="<?php if (isset($_COOKIE["uname"])) echo $_COOKIE["uname"]; ?>"class="form-control" /> <!-- value="<?php if (isset($_COOKIE["uname"])) echo $_COOKIE["uname"]; ?>"  -->
                    </div>
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4 text-center">    
       		 New UserDetails? <a href="register.php">Sign Up Here</a>
        </div>
    </div>
</div>
